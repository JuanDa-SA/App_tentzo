...
//     echo "Nombre del equipo: " . htmlspecialchars($nombre_equipo) . "<br>";
//     echo "Torneo: " . htmlspecialchars($torneo) . "<br>";
// } else {
    ...
    <div class="contenedor contenedor-registro">
      <div class="cont-registro ">
        ...
        <label class="input-label" for="permiso3">Acepto</label>
            ...
            <!-- <div class="col-12  entrada">
              <label class="input-label" for="archivo2">Logo (opcional) (Formato: .PNG):</label>
              <input class="input-form" type="file"  id="archivo2" name="archivo2" accept="image/png">
            </div>
             -->
