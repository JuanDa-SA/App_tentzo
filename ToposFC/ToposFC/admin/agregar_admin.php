...
<body>
    ...
    <div class="form-container">
        <form method="post" action="../includes/agregar_admin.php">
            <label for="input1">Ingresa el nuevo administrador:</label>
            <input class="input-form" type="text" id="numero_cel" name="txtusuario" placeholder="Administrador">
            
            <label for="input2">Ingresa una nueva contraseña:</label>
            <input class="input-form" type="password" id="numero_cel" name="txtpassword" placeholder="Contraseña"></li>
            
            <button type="submit">Confirmar el registro de administrador</button>
        </form>
    </div>
