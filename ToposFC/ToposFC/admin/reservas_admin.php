<?php
require_once '../includes/reservas_admin_view.inc.php';
...
<header>
  ...
  <main class="">
    <div class="contenedor formulario mt-5 pe-5 ps-5">
        <h2 class="titulo ">Solicitudes de renta de canchas</h2>
        <div class="table-responsive">
            <table class="table table-hover border-black tabla">
                <thead>
                    <tr>
                        <th scope="col"><h4>Evento</h4></th>
                        <th scope="col"><h4>Nombre completo</h4></th>
                        <th scope="col"><h4>Correo</h4></th>
                        <th scope="col"><h4>Fecha de reserva</h4></th>
                        <th scope="col"><h4>Hora de reserva</h4></th>
                        <th scole="col"></th>
                        <th scope="col"></th>
