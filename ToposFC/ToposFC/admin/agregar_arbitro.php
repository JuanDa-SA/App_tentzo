...
<body>
    ...
    <div class="form-container">
        <form method="post" action="../includes/agregar_arbitro.inc.php">
            <label for="input1">Ingresa el nuevo arbitro:</label>
            <input class="input-form" type="text" id="numero_cel" name="txtusuario" placeholder="Nombre del arbitro">
            
            <button type="submit">Confirmar el registro de arbitro</button>
        </form>
    </div>
