...
<header>
  ...
  <h3>Agrega ganador penales, asegurarse de que se trata de un partido con un empate</h3>  
    
    <?php
      check_form_errors();
    ?>
        <form action="../includes/penales.inc.php" method="POST" id="eventoForm">
        ...
        <!-- <form action="../includes/crearTorneo.inc.php" method="POST">
            ...
            <input type="text" id="nombre_torneo" name="nombre_torneo"  value="<?php echo isset($_SESSION['nombre_torneo']) ? htmlspecialchars($_SESSION['nombre_torneo']) : ''; ?>"><br><br>

            <label for="cantidad_equipos">Cantidad de Equipos:</label><br>
            <input type="number" id="cantidad_equipos" name="cantidad_equipos" min="2" value="<?php echo isset($_SESSION['cantidad_equipos']) ? htmlspecialchars($_SESSION['cantidad_equipos']) : ''; ?>"><br><br>
