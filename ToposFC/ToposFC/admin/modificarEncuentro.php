...
?>
    ...
    <div class="form-container">
        <form method="post" action="registrar_fecha.php?id=<?php echo $id; ?>">
            <label for="input1">Ingresa nueva fecha:</label>
            <input class="input-form" type="date" id="fecha" name="fecha" >
            
            <label for="input2">Ingresa nueva hora:</label>
            <input class="input-form" type="time" id="time" name="time"></li>
            
            <button type="submit">Confirmar fecha y hora</button>
        </form>
    </div>
