<?php
require_once '../includes/tablaJugadoresAdmin_view.inc.php';
...
<div class="logo">
  ...
  <main class="">
    ...
    <a class="boton boton--morado" href="../formularioRegistroEquipo.php">Registrar Equipos</a>
        <h2 class="titulo ">Solicitudes de registro de equipos</h2>
