...
require_once '../includes/detallesReserva_view.inc.php';
...
<script>
    ...
    function confirmarReporte(id) {
        if (confirm('¿Estás seguro de que quieres confirmar la reserva?')) {
            confirmarReserva (id);
        }
    }
    ...
    function confirmarReserva (id) {
        ...
        xhttp.open('GET', '../includes/enviar_correo_confirmacion.php?id=' + reservaId, true);
        xhttp.send();
    }
</script>
</body>
