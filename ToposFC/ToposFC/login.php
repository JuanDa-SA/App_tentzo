        ...
        <div class="container-fluid">
            ...
            <div class="nav-links">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="index.html">Estadisticas</a>
                    </li>
                    <li class="nav-item">
...
<div>
    ...
    <form method="post" action="includes/login.inc.php">
        <div class="contenedor-principal">
            <div class="items">
                <img src="img/Group 13-1.svg" alt="">
                <ul class="input">
                    
                    <li><input class="input-form" type="text" id="numero_cel" name="txtusuario" placeholder="Usuario"></li>
                    <li><input class="input-form" type="password" id="numero_cel" name="txtpassword" placeholder="Contraseña"></li>
                    <li><input class="boton boton--negro" type="submit" id="numero_cel" name="Ingresar" placeholder="Login" value="Ingresar"></li>
                </ul>
            </div>
        </div>
    </form>
