  ...
  <main class="fondo-principal">
    <div class="contenedor contenedor-registro">
      <div class="cont-registro ">
        ...
        <p>Hemos observado que eres menor de edad, por lo que algunos datos serán solicitados</p>
        <?php
        $id = $_GET['id'];
          check_form_errors();
          ?>
        <div class="contenedor-form-nota">
          <form action="includes/formularioJugadorMenor.inc.php?id=<?php echo $id ?>"  method="post" enctype="multipart/form-data">
