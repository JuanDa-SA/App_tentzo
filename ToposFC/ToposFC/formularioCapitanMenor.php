  ...
  <main class="fondo-principal">
    <div class="contenedor contenedor-registro">
      <div class="cont-registro ">
        <h1>Datos del capitan</h1>
        <label class="input-label" for="apellido_paterno">Hemos observado que eres menor de edad, por lo que algunos datos serán solicitados</label>
        <?php
          check_form_errors();
          ?>
        <div class="contenedor-form-nota">
          <form action="includes/formularioCapFMenor.inc.php" method="post" enctype="multipart/form-data">
            <div class="col-12  entrada">
              <label class="input-label" for="tutor">Nombre de tutor legal<span class="rojo">*</span>:</label>
              <input class="input-form" type="text" placeholder="Nombre" id="tutor" name="tutor" value="<?php echo isset($_SESSION['tutor']) ? htmlspecialchars($_SESSION['tutor']) : ''; ?>">
            </div>
            <div class="col-12  entrada">
              <label class="input-label" for="apellido_paterno">Soy madre, padre o tutor de un menor de edad y autorizo el uso de imagen de mi hijo/a en usos de multimedia para la difusión del evento, a través del Comité Organizador del Torneo de Fútbol 5 "La Madriguera" <span class="rojo">*</span>:</label>
              <a class="enlace-aviso" href="https://drive.google.com/file/d/1XaKUjhrQ_pD4izPLUyM_YAspJIuZ9Aun/view">*Consulta nuestro uso de imagen para menores de edad, dando click en este enlace</a>
              <p>
        ...
        <label class="input-label" for="permiso3">Acepto</label>
            ...
            <!-- <div class="col-12  entrada">
              <label class="input-label" for="archivo">Logo (opcional) (Formato: .PNG):</label>
              <input class="input-form" type="file"  id="archivo" name="archivo" accept="image/png">
            </div> -->
